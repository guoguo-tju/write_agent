...
NODE_REGISTRY: dict[str, NodeDef] = {
    ...
    "API.XHS_TRENDS.CATEGORIES": NodeDef(
        ...
        owner="backend",
        description="小红书分类列表入口",
        in_out_contract="query xhs categories",
    ),
    "API.XHS_TRENDS.GET": NodeDef(
        ...
        owner="backend",
        description="小红书热点列表入口",
        in_out_contract="query xhs trends list",
    ),
    "API.XHS_TRENDS.REFRESH": NodeDef(
        ...
        in_out_contract="refresh xhs trends cache",
    ),
    "API.XHS_TRENDS.ANALYSIS_STREAM": NodeDef(
        ...
        owner="backend",
        description="小红书热点分析 SSE 入口",
        in_out_contract="xhs analysis stream",
    ),
    "API.XHS_TRENDS.SSE_EVENT": NodeDef(
        ...
        owner="backend",
        description="小红书热点分析 SSE 事件发射",
        in_out_contract="analysis chunk -> sse event",
    ),
    ...
    "SVC.XHS_TRENDS.GET": NodeDef(
        ...
        in_out_contract="category/sort/limit -> trends list",
    ),
    ...
    "SVC.XHS_TRENDS.ANALYZE": NodeDef(
        ...
        in_out_contract="category -> analysis payload",
    ),
    ...
    "SVC.XHS_TRENDS.MCP_CALL": NodeDef(
        ...
        owner="backend",
        description="小红书 MCP 工具调用",
        in_out_contract="tool call -> parsed payload",
    ),
}
